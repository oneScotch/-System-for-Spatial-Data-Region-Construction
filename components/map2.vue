  ...
  export default {
    ...
    data() {
      return {
        ...
        lastLng: null,
        getNextPage: null,
        // center around singapore
        DEFAULT_LAT: 1.3264129,
        DEFAULT_LNG: 103.8077371,
        geocoder: null,
        placesService: null,
    ...
    mounted: function () {
      // use your own key...
      $Scriptjs("https://maps.googleapis.com/maps/api/js?key=AIzaSyBzlLYISGjL_ovJwAehh6ydhB56fCCpPQw&libraries=geometry,places", () => {
        this.initMap();
      });
